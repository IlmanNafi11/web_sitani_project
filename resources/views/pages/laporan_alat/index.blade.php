                ...
                <tr class="text-black">
                    ...
                    <td>
                        <x-ui.dropdown-action :title="'Lihat Aksi'" :style="'btn-soft'">
                            ...
                            <x-ui.button.delete-button :color="'btn-error'" :style="'btn-soft'" :route="route('laporan-alat.destroy' , $laporan->id)" :title="'Hapus'" :permission="'laporan-hibah.hapus'" :extraClassOption="'w-full'"></x-ui.button.delete-button>
