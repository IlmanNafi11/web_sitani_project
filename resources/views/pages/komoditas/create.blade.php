                ...
                <div class="main-content w-full overflow-y-auto p-6 rounded-xl bg-white border border-[#E5E8EC] h-fit">
                    <div class="flex flex-col gap-4">
                        <div class="border-b border-[#E5E8EC]">
                            <span class="title-label-page font-medium mb-4 block">Tambah Data Komoditas</span>
                        </div>
                                ...
                                <div class="w-full grid grid-cols-1 md:grid-cols-2 grid-rows-3 md:grid-rows-2 gap-4 mb-4">
                                    ...
                                    <div class="flex flex-col gap-3 col-span-1 row-span-2 h-full">
                                        ...
                                        <textarea id="deskripsi" name="deskripsi" rows="5"
                                            ...
                                            placeholder="Masukan deskriksi komoditas disini..."></textarea>
                                        @error('deskripsi')
                                            <p class="text-red-600">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="flex flex-col gap-3 col-span-1 row-span-1">
                                        ...
                                        <div class="relative flex items-center max-w-[8rem]">
                                            <button type="button" id="decrement-button"
                                                data-input-counter-decrement="musim"
                                            ...
                                            <button type="button" id="increment-button"
                                                data-input-counter-increment="musim"
                                        ...
                                        <p id="helper-text-musim"
                                            class="mt-2 text-sm text-gray-500 dark:text-gray-400">Mohon pilih jumlah musim antara 1 - 10</p>
                                    </div>
                                </div>
                                <x-ui.button-save formId="form-tambah-komoditas" />
                            </form>
                        </div>
                    </div>
                </div>
