            ...
            <div class="content flex-1 w-full p-8 flex">
                <div class="main-content w-full overflow-y-auto p-6 rounded-xl bg-white border border-[#E5E8EC]">
                    <div class="flex mb-8 flex-col gap-4">
                        <div>
                            <span class="title-label-page">Data Kelompok Tani</span>
                        </div>
                        <div>
                            <x-ui.bread-crumb :breadcrumbs="[['name' => 'Kelompok Tani', 'url' => route('kelompok-tani.index')], ['name' => 'Data Kelompok Tani']]" />
                        </div>
                    </div>
                        ...
                        <tbody>
                            @forelse ($kelompokTanis as $kelompokTani)
                                <tr class="text-black">
                                    ...
                                    <td class="flex gap-3">
                                        <x-ui.button-edit id="{{ $kelompokTani->id }}" route="kelompok-tani.edit" />
                                        <x-ui.button-delete route="kelompok-tani.destroy" id="{{ $kelompokTani->id }}" />
                                    </td>
                                </tr>
                            @empty
