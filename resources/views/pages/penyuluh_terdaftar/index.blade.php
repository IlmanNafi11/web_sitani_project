            ...
            <div class="content flex-1 w-full p-8 flex">
                <div class="main-content w-full overflow-y-auto p-6 rounded-xl bg-white border border-[#E5E8EC]">
                    <div class="flex mb-8 flex-col gap-4">
                        <div>
                            <span class="title-label-page">Data Penyuluh</span>
                        </div>
                        <div>
                            <x-ui.bread-crumb :breadcrumbs="[['name' => 'Penyuluh', 'url' => route('penyuluh-terdaftar.index')], ['name' => 'Data Penyuluh']]" />
                        </div>
                    </div>
                        ...
                        <tbody>
                            @forelse ($penyuluhs as $penyuluh)
                                <tr class="text-black">
                                    ...
                                    <td class="flex gap-3">
                                        <x-ui.button-edit id="{{ $penyuluh->id }}" route="penyuluh-terdaftar.edit" />
                                        <x-ui.button-delete route="penyuluh-terdaftar.destroy" id="{{ $penyuluh->id }}" />
                                    </td>
                                </tr>
                            @empty
            ...
            $(document).ready(function () {
                ...
                dataTable.prepend(`
                                                                <div class="action-header-container flex flex-wrap gap-4">
                                                                    <a href="{{ route('penyuluh-terdaftar.create') }}"
