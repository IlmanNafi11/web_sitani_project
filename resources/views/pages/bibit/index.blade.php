            ...
            <div class="content flex-1 w-full p-8 flex">
                <div class="main-content w-full overflow-y-auto p-6 rounded-xl bg-white border border-[#E5E8EC]">
                    <div class="flex mb-8 flex-col gap-4">
                        <div>
                            <span class="title-label-page">Data Bibit</span>
                        </div>
                        <div>
                            <x-ui.bread-crumb :breadcrumbs="[['name' => 'Bibit', 'url' => route('bibit.index')], ['name' => 'Data Bibit']]" />
                        </div>
                    </div>
                        ...
                        <tbody>
                            @forelse ($datas as $bibit)
                                <tr class="text-black">
                                    ...
                                    <td class="flex gap-3">
                                        <x-ui.button-edit id="{{ $bibit->id }}" route="bibit.edit" />
                                        <x-ui.button-delete route="bibit.destroy" id="{{ $bibit->id }}" />
                                    </td>
                                </tr>
                            @empty
